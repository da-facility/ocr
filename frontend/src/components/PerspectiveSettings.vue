...
<template>
  <div class="p-5 space-y-6">
    <section>
      <h3 class="text-xs uppercase tracking-widest text-midnight-500 mb-4">Perspective Correction</h3>
      ...
      <div class="space-y-4">
        ...
        <div v-if="session?.perspective_output_size" class="flex items-center justify-between text-sm">
    ...
    <section>
      <h3 class="text-xs uppercase tracking-widest text-midnight-500 mb-3">Instructions</h3>
    ...
    <section>
      <h3 class="text-xs uppercase tracking-widest text-midnight-500 mb-3">Point Order</h3>
      <div class="grid grid-cols-2 gap-2 text-xs">
        <div class="flex items-center gap-2">
          <div class="w-3 h-3 rounded-full bg-[#00d9ff]"></div>
          <span class="text-midnight-400">TL - Top Left</span>
        </div>
        <div class="flex items-center gap-2">
          <div class="w-3 h-3 rounded-full bg-[#00ff9d]"></div>
        ...
        <div class="flex items-center gap-2">
          <div class="w-3 h-3 rounded-full bg-[#ffb347]"></div>
